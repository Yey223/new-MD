...
_sewa.expiredCheck(danzz, sewa)
	...
	if (db.data.settings[botNumber].autobio) {
		...
		await danzz.setStatus(`${'©Danzz-MD'} | Runtime : ${runtime(uptime)}`)
...
Ketik *nyerah* untuk menyerah dan mengakui kekalahan`
            ...
            if (this.game) {
            delete this.game
            danzz.sendText(m.chat, `Berhasil delete session TicTacToe`, m)
            } else if (!this.game) {
...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
            ...
            case 'sc': {
                anu = `*Base Ori : Ramdani*
https://github.com/Ramdaniofficial

*Recode By : Danzz-MD*
https://youtube.com/c/DanzzCoding`
let btn = [{
                                urlButton: {
                        ...
                        danzz.send5ButImg(m.chat, anu, '©Danzz-MD', global.thumb, btn, global.thumb)
                        } else if (setbot.templateGif) {
                        danzz.send5ButGif(m.chat, anu, '©Danzz-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateVid) {
                        danzz.send5ButVid(m.chat, anu, '©Danzz-MD', global.visoka, btn, global.thumb)
                        } else if (setbot.templateMsg) {
                        danzz.send5ButMsg(m.chat, anu, '©Danzz-MD', btn)
                        } else if (setbot.templateLocation) {
                        danzz.send5ButLoc(m.chat, anu, '©Danzz-MD', global.thumb, btn)
                        }
                     }
            break
            case 'chat': {
                ...
                if (args[0] === 'mute') {
                    danzz.chatModify({ mute: 'Infinity' }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unmute') {
                    danzz.chatModify({ mute: null }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'archive') {
                    danzz.chatModify({  archive: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unarchive') {
                    danzz.chatModify({ archive: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'read') {
                    danzz.chatModify({ markRead: true }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'unread') {
                    danzz.chatModify({ markRead: false }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                } else if (args[0] === 'delete') {
                    danzz.chatModify({ clear: { message: { id: m.quoted.id, fromMe: true }} }, m.chat, []).then((res) => m.reply(jsonformat(res))).catch((err) => m.reply(jsonformat(err)))
                }
            }
            break
	    case 'family100': {
...
@${me.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, jawab, '© Danzz-MD', m, {mentions: ments})
            }
            break
            case 'jadian': {
            if (!m.isGroup) throw mess.group
...
@${orang.split('@')[0]} ❤️ @${jodoh.split('@')[0]}`
            ...
            let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, jawab, '© Danzz-MD', m, {mentions: menst})
            }
            break
            case 'react': {
                if (!isCreator) throw mess.owner
                ...
                danzz.sendMessage(m.chat, reactionMessage)
            }
            break  
            case 'join': {
                if (!isCreator) throw mess.owner
...
break
		case 'deletevote': case'delvote': case 'hapusvote': {
            ...
            break
               case 'group': case 'grup': {
                ...
                let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `Mode Group`, '© Danzz-MD', m)
            ...
            case 'editinfo': {
             ...
             let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `Mode Edit Info`, '© Danzz-MD', m)
            ...
            case 'antilink': {
                ...
                m.reply(`Antilink Tidak Aktif !`)
                 ...
                 let buttons = [
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `Mode Antilink`, '© Danzz-MD', m)
                }
             }
             break
             case 'mute': {
                ...
                for (let i of anu) {
                    ...
                    let btn = [{
                                ...
                                urlButton: {
                                    ...
                                    url: 'https://api-danzzz.herokuapp.com/'
                                }
                                }, {
                                quickReplyButton: {
                                    displayText: 'Donasi💰',
		...
		for (let yoi of anu) {
		    ...
		    let btn = [{
                      ...
                      let txt = `「 Broadcast Bot 」\n\n${text}`
                      danzz.send5ButImg(yoi, txt, '© Danzz-MD', global.thumb, btn)
		}
		m.reply('Sukses Broadcast')
            ...
            case 'infochat': {
                ...
                danzz.sendTextWithMentions(m.chat, teks, m)
            }
            break
            case 'q': case 'quoted': {
		if (!m.quoted) return m.reply('Reply Pesannya!!')
		let wokwol = await danzz.serializeM(await m.getQuotedObj())
            ...
            case 'listpc': {
             ...
             break
                case 'listgc': {
                 ...
                 for (let i of anu) {
                     let metadata = await danzz.groupMetadata(i)
             ...
             case 'listonline': case 'liston': {
                    ...
                    danzz.sendText(m.chat, 'List Online:\n\n' + online.map(v => '⭔ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
		...
		let { webp2mp4File } = require('./lib/uploader')
            ...
            let { toAudio } = require('./lib/converter')
            let audio = await toAudio(media, 'mp4')
            danzz.sendMessage(m.chat, {document: audio, mimetype: 'audio/mpeg', fileName: `Convert By ${'© DanzzCoding'}.mp3`}, { quoted : m })
            }
            break
...
⭔ Url : ${anu.url}`,
		...
		let { pinterest } = require('./lib/scraper')
            ...
            case 'anime': case 'waifu': case 'husbu': case 'neko': case 'shinobu': case 'megumin': case 'waifus': case 'nekos': case 'trap': case 'blowjob': {
                m.reply(mess.wait)
                danzz.sendMessage(m.chat, { image: { url: api('zenz', '/api/random/'+command, {}, 'apikey') }, caption: 'Generate Random ' + command }, { quoted: m })
            }
            break
	    case 'couple': {
                m.reply(mess.wait)
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6289512545999`
            ...
            case 'ramalanjodoh': case 'ramaljodoh': {
                if (!text) throw `Example : ${prefix + command} Dani, 7, 7, 2005, Fira, 16, 11, 2004`
            ...
            case 'ramalanjodohbali': case 'ramaljodohbali': {
                if (!text) throw `Example : ${prefix + command} Dani, 7, 7, 2005, Novia, 16, 11, 2004`
                let [nama1, tgl1, bln1, thn1, nama2, tgl2, bln2, thn2] = text.split`,`
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
		    ...
		    db.data.users[m.sender].limit -= 1
                    ...
                    if (anu.status == false) return m.reply(anu.result.message)
                    danzz.sendMedia(m.chat, anu.caption.profile_hd, '', `⭔ Full Name : ${anu.caption.full_name}\n⭔ User Name : ${anu.caption.user_name}\n⭔ ID ${anu.caption.user_id}\n⭔ Followers : ${anu.caption.followers}\n⭔ Following : ${anu.caption.following}\n⭔ Bussines : ${anu.caption.bussines}\n⭔ Profesional : ${anu.caption.profesional}\n⭔ Verified : ${anu.caption.verified}\n⭔ Private : ${anu.caption.private}\n⭔ Bio : ${anu.caption.biography}\n⭔ Bio Url : ${anu.caption.bio_url}`, m)
		    db.data.users[m.sender].limit -= 1
            ...
            case 'joox': case 'jooxdl': {
                ...
                let msg = await danzz.sendImage(m.chat, anu.result.img, `⭔ Title : ${anu.result.lagu}\n⭔ Album : ${anu.result.album}\n⭔ Singer : ${anu.result.penyanyi}\n⭔ Publish : ${anu.result.publish}\n⭔ Lirik :\n${anu.result.lirik.result}`, m)
...
`,
		    ...
		    anu.media.map(async (url) => {
		        danzz.sendMessage(m.chat, { image: { url }, caption: `⭔ Title : ${anu.title}\n⭔ Author : ${anu.author.name}\n⭔ Like : ${anu.like}\n⭔ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
		...
		let result = anu[Math.floor(Math.random() * anu.length)]
		danzz.sendMessage(m.chat, { audio: { url: result.audio }, fileName: result.title+'.mp3', mimetype: 'audio/mpeg' }, { quoted: m })
	    }
	    break
		case 'iqra': {
		...
		if (args[0] === 'pdf') {
		m.reply(mess.wait)
		danzz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pdf'}, mimetype: 'application/pdf', fileName: 'juz-amma-arab-latin-indonesia.pdf'}, {quoted:m})
		} else if (args[0] === 'docx') {
		m.reply(mess.wait)
		danzz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.docx'}, mimetype: 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', fileName: 'juz-amma-arab-latin-indonesia.docx'}, {quoted:m})
		} else if (args[0] === 'pptx') {
		m.reply(mess.wait)
		danzz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.pptx'}, mimetype: 'application/vnd.openxmlformats-officedocument.presentationml.presentation', fileName: 'juz-amma-arab-latin-indonesia.pptx'}, {quoted:m})
		} else if (args[0] === 'xlsx') {
		m.reply(mess.wait)
		danzz.sendMessage(m.chat, {document: {url: 'https://fatiharridho.my.id/database/islam/juz-amma-arab-latin-indonesia.xlsx'}, mimetype: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileName: 'juz-amma-arab-latin-indonesia.xlsx'}, {quoted:m})
		} else {
...
( Q.S ${res.result.data.surah.name.transliteration.id} : ${res.result.data.number.inSurah} )`
		...
		break
		   case 'bass': case 'blown': case 'deep': case 'earrape': case 'fast': case 'fat': case 'nightcore': case 'reverse': case 'robot': case 'slow': case 'smooth': case 'tupai':
                ...
                danzz.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
...
`.trim()
                danzz.sendText(m.chat, teks, m, { mentions: Object.values(global.db.data.sticker).map(x => x.mentionedJid).reduce((a,b) => [...a, ...b], []) })
            }
            break
            case 'lockcmd': {
                if (!isCreator) throw mess.owner
...
Lihat list Pesan Dengan ${prefix}listmsg`)
            ...
            case 'getmsg': {
                ...
                danzz.copyNForward(m.chat, msgs[text.toLowerCase()], true)
            }
            break
            case 'listmsg': {
	    ...
	    case 'anonymous': {
            ...
            case 'mulai': case 'start': {
                ...
                if (Object.values(this.anonymous).find(room => room.check(m.sender))) {
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `\`\`\`Kamu Masih Berada Di dalam Sesi Anonymous, Tekan Button Dibawah Ini Untuk Menghentikan Sesi Anonymous Anda\`\`\``, '© DanzzCoding', m)
                    throw false
                }
                ...
                if (room) {
                    ...
                    await danzz.sendButtonText(room.a, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '© DanzzCoding', m)
                    room.b = m.sender
                    room.state = 'CHATTING'
                    await danzz.sendButtonText(room.b, buttons, `\`\`\`Berhasil Menemukan Partner, sekarang kamu dapat mengirim pesan\`\`\``, '© DanzzCoding', m)
                } else {
                    let id = + new Date
                    this.anonymous[id] = {
                        id,
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '© DanzzCoding', m)
                }
                break
            }
            case 'next': case 'lanjut': {
                ...
                if (room) {
                    ...
                    await danzz.sendButtonText(m.chat, buttons, `\`\`\`Mohon Tunggu Sedang Mencari Partner\`\`\``, '© Danzz-MD', m)
                }
                break
            }
            case 'public': {
...
⭔ Detail: ${detail}`
            ...
            danzz.sendImage(m.chat, res.result[0].thumb, capt, m)
            }
            break
            ...
            danzz.sendImage(m.chat, res.result[0].img, capt, m)
            }
            break
            case 'aminio': {
            ...
            danzz.sendImage(m.chat, 'https://'+res.result[0].community_thumb, capt, m)
            }
            break
            case 'wattpad': {
            ...
            danzz.sendImage(m.chat, res.result[0].thumbnail, capt, m)
            }
            break
            case 'setmenu': {
            if (!isCreator) throw mess.owner
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                danzz.sendListMsg(m.chat, `Please select the menu you want to change!`, '© DanzzCoding', `Hello Owner !`, `Click Here`, sections, m)
                }
            }
            break
            ...
            case 'santuy': {
            m.reply(mess.wait)	
		santuy = await getBuffer(`https://danzz-rest.herokuapp.com/api/asupan/santuy?apikey=Ramdaniofficial`)
...
╰────
╭─[ *MINAT CHAT* ]
├  🪀 wa.me/6288296339947?text=SEWABOT
╰────
╭─[ *PAYMENT* ]
├  DANA
├  GOPAY
...
break
case 'gopay': {
 m.reply('DANA : 089512545999')
}
break
case 'pulsa': {
m.reply('088296339947')
}
break
// Button List
case 'command':{
...
- Ramdani
*Penyedia Rest Api* :
- https://zenzapis.xyz (Zenz)
- https://api-danzzz.herokuapp.com (Danzz)`
	let btn = [{
                                urlButton: {
                                    displayText: 'Youtube📽️',
                                    url: 'https://youtube.com/c/DanzzCoding'
